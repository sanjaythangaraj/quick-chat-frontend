...
export class HeaderComponent implements OnInit {
  ...
  private listenToLastSeen() {
    this.oauth2Service.lastSeen.subscribe(lastSeenState => {
  ...
  private pollUserPresence() {
    this.unsubscribeLastSeen();
    this.lastSeenSub = interval(5000)
        .subscribe(() => this.oauth2Service.handleLastSeen(this.userSelected?.publicId!))
  }
  ...
  private listenToDeleteConversation() {
